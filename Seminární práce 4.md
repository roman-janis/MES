...
Informace pak vznikají právě provázáním samostatných hodnot v určitém kontextu. [Pokorný a Valenta, 2020; Watt a Eng, 2014]
...
****
Systém řízení báze dat, běžně označovaný zkratkou DBMS, je specializovaný program, který umožňuje definice dat, manipulaci s daty a ukládání, zabezpečení a správu dat, která jsou uložena v databázi.
...
Spojení DBMS společně s daty dohromady tvoří celek, označovaný jako databáze. [Elmasri a Navathe (2016, s. 5)]
****
...
****
Původně se používal především jednoduchý souborový přístup, který měl záhy řadu problémů a omezení v podobě konzistentnosti dat při aktualizaci, závislosti na aplikačním programu a na fyzické struktuře, často spojené s redundancí dat. [Elmasri a Navathe (2016, s. 6)] Databázový přístup tyto nedostatky odstraňuje, a to tím, že integruje data do jednoho logického celku a odděluje definici dat od samotných aplikací.
Oddělením byla získána vyšší bezpečnost, možnost centrálního řízení integritních omezení a sdílenost dat mezi více uživateli. [Pokorný a Valenta (2020, s. 16)]
****
...
Metadata jsou data o datech obsažená ve schématech, tedy informace popisující strukturu databáze, význam atributů, integritní omezení nebo například přístupová práva. 
...
Myšlenkou bylo podívat se na stavbu databázi jako implementaci hierarchie jistých abstrakcí. Ve zprávě výboru ANSI/X3/SPARC z roku 1975 se objevuje rozdělení na externí, konceptuální a interní úroveň pohledu, kde 
...
****
Na konceptuální návrh navazuje v další části logický návrh. 
...
Nástroj určený pro návrh databázového systému by měl umožnit zachytávat požadavky, převést je do konzistentního schématu a podle potřeby podpořit i technickou implementaci v konkrétním databázovém prostředí. [*Rosenthal a Reiner (1994, s. 168)*]
