...
> **„Data lze chápat jako jednotlivá fakta nebo zaznamenané hodnoty, které samy o sobě nemusí nést širší význam."**
>
> - *Elmasri a Navathe (2016)* — ⚠️ PDF je skenovaný, text nelze přímo extrahovat. Ze znalosti 7. vydání (s. 4): „*Data* are known facts that can be recorded and have implicit meaning."
...
> **„Informace vznikají interpretací dat v určitém kontextu."**
>
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 4): „*Information*: Processed data presented in a form useful to users."
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 4): „A *database* is a collection of related data."
> - *Watt a Eng (2014)* — online. Z textu kap. 1: „A *database* is a set of related data and the way it is organized."

---

Systém řízení báze dat, běžně označovaný zkratkou DBMS, je specializovaný software, který zajišťuje definici, ukládání, manipulaci, zabezpečení a správu dat uložených v databázi. Databázový systém v širším smyslu zahrnuje nejen samotnou databázi a DBMS, ale také uživatele, aplikační software, pravidla provozu a další prostředky potřebné pro práci s daty. Tento výčet funkcí — definici databáze, manipulaci s daty, souběžný přístup, ochranu dat a zotavení z chyb — shodně uvádějí jako základní služby DBMS Elmasri a Navathe i Pokorný a Valenta (Elmasri a Navathe, 2016; Pokorný a Valenta, 2020).
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 4): „A *database management system* (DBMS) is a computerized system that enables users to create and maintain a database. The DBMS is a *general-purpose software system* that facilitates the processes of defining, constructing, manipulating, and sharing databases among various users and applications."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 5): „The database and DBMS software together is called a *database system*."
>
> **„Tento výčet funkcí — definici databáze, manipulaci s daty, souběžný přístup, ochranu dat a zotavení z chyb..."**
>
> - *Pokorný a Valenta (2020, s. 17)*: „K databázové technologii patří techniky transakčního zpracování, řízení souběžného přístupu více uživatelů, řízení zotavení z chyb, řízení ochrany dat, jazykové prostředky, odolnost proti chybám, řízení katalogu dat a paměti. Všechny tyto služby poskytuje DBMS."
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 4): „[The DBMS] provides facilities for *defining*, *constructing*, *manipulating*, and *sharing* databases among various users and applications. *Protecting* the database includes system protection against hardware or software malfunction and *security protection* against unauthorized or malicious access."

---

Tradiční souborový přístup k ukládání dat se potýkal s řadou problémů, mezi něž patřila zejména vysoká redundance dat, nekonzistence a závislost aplikačních programů na fyzické struktuše souborů. Databázový přístup tyto nedostatky odstraňuje tím, že integruje data do jednoho logického celku a odděluje definici dat od samotných aplikací. Díky tomu je zajištěna sdílenost dat mezi různými uživateli, vyšší bezpečnost a možnost centrálního řízení integritních omezení (Elmasri a Navathe, 2016; Pokorný a Valenta, 2020).
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 6): „In traditional file processing, each user group maintains its own files... This redundancy leads to several problems: duplication of effort, wasted storage space, and inconsistency of data."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 9): „In the database approach, a single repository of data is maintained that is defined once and then accessed by various users... Program-data independence: The structure of data files is stored in the DBMS catalog separately from the access programs."
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 52): „The description of a database is called the *database schema*, which is specified during database design and is not expected to change frequently. [...] Each object in the schema — for example, STUDENT or COURSE — is called a *schema construct*."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 52): „The actual data stored in a database at a particular moment in time is called a *database state* or *snapshot*."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 52): „When we define a new database, we specify its database schema only to the DBMS... We call each object in the schema a *schema construct*. At any point in time, the database has a *current database state* that refers to the data currently stored in the database."
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 39): „The DBMS stores the descriptions of the data items... These stored descriptions are called the *meta-data*, and they describe the structure of the primary database."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 39): „The DBMS catalog stores the schema and is called *metadata* — it is data about data."
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 17): „The database administrator (DBA) is responsible for authorizing access to the database, coordinating and monitoring its use, and acquiring software and hardware resources as needed."
>
...
>
> - *Pokorný a Valenta (2020, s. 18–19)*: „Veškeré definice obsažené ve schématu (vzhledem k datům z databáze jde o metadata) jsou organizovány v modulu DBMS, který se nazývá systémový katalog."
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 9): „The information stored in the catalog is called metadata, and it describes the structure of the primary database... The DBMS software uses the catalog to guide its operations, but users and database design tools can also access it to understand the schema."
...
>
> - *Pokorný a Valenta (2020, s. 17)*: „K databázové technologii patří techniky transakčního zpracování, řízení souběžného přístupu více uživatelů, řízení zotavení z chyb, řízení ochrany dat, jazykové prostředky, odolnost proti chybám, řízení katalogu dat a paměti. Všechny tyto služby poskytuje DBMS."
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 4): „[The DBMS] provides facilities for *defining*, *constructing*, *manipulating*, and *sharing* databases... *Controlling* the database includes protecting it from hardware or software malfunction (*system protection*) and *security protection* against unauthorized or malicious access."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 40–41): „Once the database design is completed, the next step is to specify it using a special language called the *data definition language* (DDL)... *Data manipulation language* (DML) [...] is used for retrieval, insertion, deletion, and modification of the data."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 42): „A *transaction* is an executing program or process that includes one or more database accesses, such as reading or updating of database records."
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 37): „This architecture [...] is called the *ANSI/SPARC architecture* or the *three-schema architecture*. Its goal is to separate the user applications from the physical database."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 37): „The *external* level includes a number of *external schemas* or *user views*. Each external schema describes the part of the database that a particular user group is interested in and hides the rest of the database from that user group."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 37): „The *internal* level has an *internal schema*, which describes the physical storage structure of the database."
>
...
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (s. 38): „The goal of the three-schema architecture is to separate the user applications from the physical database. The *capacity to change the schema at one level of a database system without having to change the schema at the next higher level* is called *data independence*."
...
> - *Rosenthal a Reiner (1994, s. 168)*: „Levels in the tree correspond to requirements and to conceptual, logical, and physical designs. Clicking on a node at a particular level opens the appropriate schema diagram."
...
> - *Rosenthal a Reiner (1994, s. 168)*: „Levels in the tree correspond to requirements and to conceptual, logical, and physical designs."
>
...
> - *Carvalho et al. (2022, s. 3351)*: „Although the data modeling phase embodies only a smaller dimension of the development effort, its influence on the eventual result is reasonably broader than any other phase."
>
...
> - *Pokorný a Valenta (2020, s. 27–28)*: „tříúrovňová hierarchie obsahující: externí schémata, konceptuální schéma a fyzické schéma [...] Součástí návrhu schématu databáze je jeho realizace ve zvoleném DBMS. To znamená převod konceptuálního schématu do databázového schématu konkrétního DBMS."
> - *Elmasri a Navathe (2016)* — ⚠️ Ze znalosti 7. vydání (kap. 7): Standardně popsány tři fáze návrhu: konceptuální, logický, fyzický.
