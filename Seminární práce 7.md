...
****
AHP se využívá hlavně v případech, kdy je potřeba při rozhodování spojit různé typy kritérií, například technické parametry, ekonomické ukazatele a kritéria, která se hodnotí spíše subjektivně nebo kvalitativně (Ishizaka a Labib, 2011; Saaty, 1990). Tento přístup odpovídá hodnocení databázových nástrojů, které nelze posuzovat jednorozměrně, ale je nutné zohlednit modelovací funkce, použitelnost či podporu generování skriptů. Využití AHP pro selekci softwaru je v souladu se závěry publikovaných přehledových studií (Ho, 2008; Simanavičienė a Vdovinskienė, 2023; Vaidya a Kumar, 2006).
****
...
****
Schopnost exaktně ověřit logickou konzistenci pomocí ukazatele CR představuje hlavní výhodu AHP oproti aditivním bodovacím metodám, a to zejména při hodnocení subjektivních kritérií, jako je přehlednost či použitelnost rozhraní (Ishizaka a Labib, 2011; Saaty, 1990; Saaty, 2008).
****
