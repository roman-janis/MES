...
Na výsledky a závěry z této práce naváže praktické porovnání v práci následující. Každý nástroj bude prakticky ověřen a hodnocen dle kritérií K1–K8. U kvalitativních kritérií K2 a K6 bude párové porovnání doplněno o slovní zdůvodnění, proto, aby bylo hodnocení pochopitelné. Výsledky budou ověřeny analýzou citlivosti pro váhy K1 a K8. Případně bude navržena jednoduchá podpůrná aplikace pro výpočet vah.
