...
Testovací scénář bude obsahvoat vytváření logického modelu, generování DDL skriptu a, pokud to nástroj umožní, taky reverzní inženýrství na produkční databáze. Na základě výsledků testování a prostudované dokumentace bude každý nástroj ohodnocen podle kritérií K1–K8. Tyto hodnocení budou vstupem do párového porovnávání v metodě AHP. Hodnocení bude obsahovat výpočet Saatyho matic, výpočet vektoru priorit a ověření poměru konzistence CR. Citlivostní analýza pak ukáže, jak změna váhy jednotlivých kritérií ovlivňuje výsledné pořadí nástrojů.
